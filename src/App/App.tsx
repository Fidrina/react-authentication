      ...
      <div className="h-screen pb-14 bg-right bg-cover" style={{ backgroundImage: `url(${bg})`}}>
        ...
        <div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
            <h1 className="my-4 text-3xl md:text-5xl text-purple-800 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">Nice to see you again, { user.name }</h1>
            ...
            <div className="flex w-full justify-center md:justify-start pb-12 lg:pb-0 fade-in">
              <AppStore></AppStore>
              <PlayStore></PlayStore>
            </div>
          </div>
